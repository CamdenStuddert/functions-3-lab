...
{"monster":"Bulbabunny","CP":135}, {"monster":"Bulbabunny","CP":250}, {"monster":"Ponylopse","CP":277},{"monster":"Ponylopse","CP":184},{"monster":"Pikadoughnet","CP":207},{"monster":"Bulbabunny","CP":139},{"monster":"Pikadoughnet","CP":47},
...
const orderTotals = orders.map(object => (object.tax + 1) * object.price)
...
const bobsTotal = purchases.filter(obj => obj.owner === "Bob").map((obj) => obj.price).reduce((acc, cur) => acc + cur)
